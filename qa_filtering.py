...
def qa_filterer(path = '/Users/thibaultbret', total_qa_xlsx = '/Users/thibaultbret/total_qa_df.xlsx', completeness_th = 0.9, contamination_th = 0.05):
    '''
    Reads the total qa Excel sheet and, based on the completeness and the percentage of contamination of each genome, given
